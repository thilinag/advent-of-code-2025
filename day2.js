...
const part1 = () => {
    ...
    /*
     * Cut he number in half and check if both halves are equal
     */
...
const part2 = () => {
    ...
    /*
     * Similar to part 1, but check for any group of repeated digits
     * via regex capturing groups.
     * For example, "1212" matches with "12" as the captured group,
     * and "3333" matches with "3" as the captured group.
     */
